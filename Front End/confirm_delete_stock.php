...
<html dir="rtl" lang="en-US"><head><!-- Created by Artisteer v4.1.0.60046 -->
   <meta charset="utf-8">
   <title>Confirm Stock Delete</title>
...
<body>
                           ...
                           <div class="art-content-layout-wrapper layout-item-0">
                                    ...
                                    <div class="art-layout-cell layout-item-2" style="width: 100%" >
                                       <ul>
                                          <li>
                                            ...
                                            line-height: normal;">فورم حذف گدام
                                             </span>
                                          </li>
                                       </ul>
                                    </div>
                              ...
                              <div align="center" style="border : 0; margin: 10px">
                                 <div align="center" class="art-layout-cell layout-item-5" style="width: 100%" >
                                    ...
                                    <p class="text">
                                      آیا میخواهید گدام <span style="color:rgba(255,0,0,1)"><?php echo $stockName;?> </span> را از لیست گدام های خود حذف کنید؟
                                    </p>
                                    <p class="text" style="color: blue">با حذف این گدام از لیست گدام ها تمام معاملات مربوط به این گدام از لیست معاملات حذف خواهد شد!</p>
                                    <p class="text">
                                      <a id="ok" href="../back end/php/deleteStock.php?id=<?php echo $stockId ?>">بلی</a>
   ...
   <script type="text/javascript">
      $("#ok").on("click", function(e){
        if(confirm("با حذف تمام معاملات مربوط به گدام مذکور موافق هستید؟"))
        {
