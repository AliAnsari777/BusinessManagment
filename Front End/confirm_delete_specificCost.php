...
<html dir="rtl" lang="en-US"><head><!-- Created by Artisteer v4.1.0.60046 -->
   <meta charset="utf-8">
   <title>Confirm Specific Cost Delete</title>
...
<body>
                           ...
                           <div class="art-content-layout-wrapper layout-item-0">
                              ...
                              <div align="center" style="border : 0; margin: 10px">
                                 <div align="center" class="art-layout-cell layout-item-5" style="width: 100%" >
                                    ...
                                    <p class="text">
                                      آیا میخواهید این مصرف را از لیست مصارف اختصاصی معامله <?php echo $gName . " توسط " . $cName ?>  حذف کنید؟
                                    </p>
                                    <p class="text">
                                      <a id="ok" href="../back end/php/deleteSpecificCost.php?id=<?php echo $costId ?>&goods=<?php echo $gName ?>&customer=<?php echo $cName ?>&bid=<?php echo $B_ID ?>&Tdate=<?php echo $tradeDate ?>&C_ID=<?php echo $C_ID ?>">بلی</a>
   ...
   <script type="text/javascript">
      $("#cancel").on("click", function(){
         location="cost.php?id=<?php echo $B_ID ?>&goods=<?php echo $gName ?>&customer=<?php echo $cName ?>&Tdate=<?php echo $tradeDate ?>&C_ID=<?php echo $C_ID ?>";
      });
   </script>
</html>