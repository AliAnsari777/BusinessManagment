...
<html dir="rtl" lang="en-US"><head><!-- Created by Artisteer v4.1.0.60046 -->
   ...
   <style>
      ...
      .art-content .art-postcontent-0 .layout-item-1 { border-top-style:solid;border-right-style:solid;border-bottom-style:solid;border-left-style:solid;border-width:1px;border-color:#4396C7; color: #737373; background: #EFF2F5; border-spacing: 10px 0px; border-collapse: separate;  background-color: #78c4ef; margin-top: -10px; height: 70px}
                           ...
                           <div class="art-content-layout-wrapper layout-item-0">
                                 ...
                                 <div class="art-content-layout-row">
                                    <div class="art-layout-cell layout-item-2" style="width: 100%" >
                                      <br />
                                       <ul>
                                          <li>
                                             <span style="font-family: Tahoma; font-size: 18px; font-weight: bold; color: rgb(0, 0, 0)">
                                                صفحه حذف قسط
                                             </span>
                                          </li>
                                       </ul>
                              ...
                              <div align="center" style="border : 0; margin: 10px">
                                 <div align="center" class="art-layout-cell layout-item-5" style="width: 100%" >
                                    ...
                                    <p class="text">
                                      آیا میخواهید این قسط را از لیست اقساط حذف کنید؟
                                    </p>
                                    <p class="text">
                                      <a id="ok" href="../back end/php/deleteInstallment.php?id=<?php echo $I_ID; ?>">بلی</a>
