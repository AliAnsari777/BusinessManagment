<?php
   ...
   if(isset($_GET['id']))
   {
      ...
      $goodsName = htmlentities($_GET['name']);
   }
?>
<!DOCTYPE html>
...
<body>
                           ...
                           <div class="art-content-layout-wrapper layout-item-0">
                              ...
                              <div align="center" style="border : 0; margin: 10px">
                                 <div align="center" class="art-layout-cell layout-item-5" style="width: 100%" >
                                    ...
                                    <p class="text">
                                      آیا میخواهید <span style="color:rgba(255,0,0,1)"><?php echo $goodsName;?> </span> را از لیست اجناس خود حذف کنید؟
                                    </p>
                                    <p class="text" style="color: blue">با حذف این جنس از لیست اجناس تمام معاملات مربوط به این جنس از لیست معاملات حذف خواهد شد!</p>
                                    <p class="text">
                                      <a id="ok" href="../back end/php/deleteGoods.php?id=<?php echo $goodsId ?>">بلی</a>
   ...
   <script type="text/javascript">
      $("#ok").on("click", function(e){
        if(confirm("با حذف تمام معاملات مربوط به جنس مذکور موافق هستید؟"))
        {
