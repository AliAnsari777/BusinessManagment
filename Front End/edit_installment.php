<?php
   ...
   if(isset($_GET['I_id']))
   {
      ...
      // these informations are come from payment&receipt page which calls installmentList function from paymentsClass.php
      $I_ID =  htmlentities($_GET['I_id']);
...
<html dir="rtl" lang="en-US"><head>
   ...
   <style>
     ...
     input[type = text] {text-indent: 10px; font-family: Tahoma; font-size: 16px; font-weight: bold; color: rgb(0, 0, 0); line-height: normal}
                                 ...
                                 <div class="art-content-layout-row">
                                    ...
                                    <div align="center" class="art-layout-cell layout-item-5" style="width: 100%" >
                                       <?php
                                          ...
                                          $editPayment->EditInstallment($I_ID, $C_ID);
                                       ?>
                                    </div>
                                 </div>
                              </div>
